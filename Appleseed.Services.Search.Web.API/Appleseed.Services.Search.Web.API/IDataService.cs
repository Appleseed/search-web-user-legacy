...
namespace Appleseed.Services.Search.Web.API
{
    ...
    {
        [OperationContract]
        [WebGet(UriTemplate = "{indexType}/{collectionName}/Select/{query}/{pageSize}/{pageIndex}", ResponseFormat = WebMessageFormat.Json)]
        SearchResult GetCollectionByQuery(string indexType, string collectionName, string query, string pageSize, string pageIndex);
